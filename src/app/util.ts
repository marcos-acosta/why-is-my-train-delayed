...
export const ISSUES = [
  ...
  "Door problem",
  "Signal problem",
  "Unspecified train problem",
  "Unspecified mechanical problem",
  "Unspecified NYPD response",
  "Switch problem",
  "Person on tracks",
  "Track maintenance",
  "Cleaning",
  "Fire / smoke",
  "South Channel Bridge open",
  "Rail problem",
  "Unspecified EMS response",
  "Something on tracks",
  "Power issue",
  "Vandalism",
  ...
  "Work train-related",
  "Unspecified FDNY response",
  "Short-staffed",
  "Fallen tree",
  "Switch maintenance",
  "Emergency brake cord pulled",
  "Signal maintenance",
  "Track inspection",
